...
mod tests {
    ...
    fn register_ram_reset_none() {
        assert_eq!(RegisterRamReset::new().as_u8(), 0);
    }

    #[test]
    fn register_ram_reset_palette() {
        assert_eq!(RegisterRamReset::new().with_palette().as_u8(), 4);
    }

    #[test]
    fn register_ram_reset_vram() {
        assert_eq!(RegisterRamReset::new().with_vram().as_u8(), 8);
    }

    #[test]
    fn register_ram_reset_oam() {
        assert_eq!(RegisterRamReset::new().with_oam().as_u8(), 16);
    }

    #[test]
    fn register_ram_reset_sio_registers() {
        assert_eq!(RegisterRamReset::new().with_sio_registers().as_u8(), 32);
    }

    #[test]
    fn register_ram_reset_sound_registers() {
        assert_eq!(RegisterRamReset::new().with_sound_registers().as_u8(), 64);
    }

    #[test]
    fn register_ram_reset_other_registers() {
        assert_eq!(RegisterRamReset::new().with_other_registers().as_u8(), 128);
    }
